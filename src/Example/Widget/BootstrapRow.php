...
class BootstrapRow extends AbstractWidgetComponent
{
    ...
    {
        return 'Provides bootstrap row element';
    }
    ...
    public function makeDisplayContent(
        ...
        $class = isset($properties['class']) ? $properties['class'] : 'col-md-1';
